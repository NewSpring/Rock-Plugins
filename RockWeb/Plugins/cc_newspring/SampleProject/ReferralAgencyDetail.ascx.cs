...
namespace RockWeb.Plugins.cc_newspring.SampleProject
{
    /// <summary>
    /// Displays the details of a Referral Agency.
    /// </summary>
    [DisplayName( "Referral Agency Detail" )]
    [Category( "cc_newspring > Sample Project" )]
    ...
    public partial class ReferralAgencyDetail : Rock.Web.UI.RockBlock
    {
        ...
        protected override void OnInit( EventArgs e )
        {
            ...
            var definedType = DefinedTypeCache.Read( cc.newspring.SampleProject.SystemGuid.DefinedType.REFERRAL_AGENCY_TYPE.AsGuid() );
            if (definedType != null)
            {
