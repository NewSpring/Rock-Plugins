<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Ooyala.ascx.cs" Inherits="RockWeb.Plugins.cc_newspring.Video.Ooyala" %>
...
<div class="embed-responsive embed-responsive-16by9">
    ...
    <script type="text/javascript" src="../plugins/cc_newspring/Video/scripts.js"></script>
</div>