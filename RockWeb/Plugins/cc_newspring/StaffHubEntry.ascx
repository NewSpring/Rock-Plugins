<%@ Control Language="C#" AutoEventWireup="true" CodeFile="StaffHubEntry.ascx.cs" Inherits="RockWeb.Blocks.Cms.StaffCalendarEntry" %>
        ...
        <asp:Panel ID="pnlDetails" CssClass="panel panel-block" runat="server">
            ...
            <div class="panel-body">
                ...
                <asp:Panel ID="pnlEditDetails" runat="server">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <Rock:HtmlEditor ID="htmlContent" runat="server" Label="Content" ResizeMaxWidth="720" Height="200" />
