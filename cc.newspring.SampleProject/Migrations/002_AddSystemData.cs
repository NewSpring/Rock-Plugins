...
" );
            ...
            RockMigrationHelper.UpdateBlockType( "Referral Agency Detail", "Displays the details of a Referral Agency.", "~/Plugins/cc_newspring/SampleProject/ReferralAgencyDetail.ascx", "cc_newspring > Sample Project", "2F130DF6-1EE4-45CE-9410-CBB0517EB33E" );
            RockMigrationHelper.UpdateBlockType( "Referral Agency List", "Lists all the Referral Agencies.", "~/Plugins/cc_newspring/SampleProject/ReferralAgencyList.ascx", "cc_newspring > Sample Project", "53F447CE-4B91-470A-A15D-B60DCAAB29CB" );
        ...
        {
            Sql( @"
    UPDATE [_cc_newspring_SampleProject_ReferralAgency] SET [AgencyTypeValueId] = NULL
" );
